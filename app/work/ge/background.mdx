...
A complete overhaul was not seen as just, but a significant overhaul of current elements visuality was under inspection. New components included all needed interactivity states that make the new user interface more user friendly.
