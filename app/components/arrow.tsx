  ...
  return (
    <div>
      {!expand ? (
        ...
        <div
          className={`opacity-0 w-0 group-hover:mr-10 group-hover:opacity-100 [transform-origin:50%_50%] [transform-box:fill-box] transition-all duration-200 animate-fade-in`}
        >
          <svg
            height={size}
            viewBox="0 0 70 94"
